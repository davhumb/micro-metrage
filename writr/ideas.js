window.ideas = [
  ...
  {
    "categorie": "Contrainte stylistique",
    "abstraction": "contrainte",
    "consigne": "Écris une scène entièrement composée de phrases nominales, sans aucun verbe conjugué."
  },
  {
    "categorie": "Contrainte stylistique",
    "abstraction": "contrainte",
    "consigne": "Utilise uniquement des phrases de moins de six mots pour créer un effet haletant ou saccadé."
  },
  {
    "categorie": "Contrainte stylistique",
    "abstraction": "contrainte",
    "consigne": "Fais parler un personnage uniquement à travers ses silences et ses gestes — les mots viennent des autres."
  },
  {
    "categorie": "Contrainte stylistique",
    "abstraction": "contrainte",
    "consigne": "Compose un dialogue sans aucune ponctuation. L’intonation et la signification doivent naître du contexte seul."
  },
  {
    "categorie": "Contrainte stylistique",
    "abstraction": "contrainte",
    "consigne": "Écris une description poétique d’un moment banal, comme un petit-déjeuner ou un trajet en bus."
  },
  {
    "categorie": "Cadavre narratif",
    "abstraction": "défi de construction",
    "consigne": "Écris une histoire comme s’il s’agissait des fragments retrouvés dans une boîte."
  },
  {
    "categorie": "Cadavre narratif",
    "abstraction": "défi de construction",
    "consigne": "Commence ton histoire avec la fin, puis remonte par bribes illogiques, comme une mémoire trouée."
  },
  {
    "categorie": "Cadavre narratif",
    "abstraction": "défi de construction",
    "consigne": "Utilise uniquement des phrases incomplètes, interrompues, comme si le texte avait été censuré ou effacé."
  },
  {
    "categorie": "Cadavre narratif",
    "abstraction": "défi de construction",
    "consigne": "Laisse volontairement des paragraphes absents, avec des indications comme '[page manquante]'."
  },
  {
    "categorie": "Cadavre narratif",
    "abstraction": "défi de construction",
    "consigne": "Construit ton récit à partir de phrases éparses, retrouvées dans des carnets, mails ou papiers griffonnés."
  }
];