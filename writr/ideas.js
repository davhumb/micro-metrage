...
,
  { categorie: "Objet narratif", abstraction: "événement", consigne: "Écris une histoire racontée par une paire de chaussures usée." },
  { categorie: "Voisinage", abstraction: "situation", consigne: "Ton personnage découvre que son voisin lui ressemble exactement… en tout point." },
  { categorie: "Rupture du réel", abstraction: "événement", consigne: "Un personnage réalise que les lois physiques ne s’appliquent plus autour de lui." },
  { categorie: "Défi Mash-up", abstraction: "contrainte", consigne: "Mélange l’univers d’un conte de fée avec un thriller politique contemporain." },
  { categorie: "Défi de narration inversée", abstraction: "structure", consigne: "Raconte une histoire en partant de la scène finale jusqu’à la première, scène par scène." },
  { categorie: "Observation", abstraction: "déclencheur", consigne: "Invente une intrigue entière à partir d’un geste banal observé dans un café." },
  { categorie: "Voix intérieure", abstraction: "forme", consigne: "Écris une scène où seul le flux de pensée du personnage est audible." },
  { categorie: "Présent toxique", abstraction: "univers", consigne: "Décris une société où les gens ne peuvent plus s’exprimer que par émojis." },
  { categorie: "Silence", abstraction: "forme", consigne: "Crée une scène de rupture sans aucun dialogue." },
  { categorie: "Faux-semblants", abstraction: "déclencheur", consigne: "Un personnage découvre que tout ce qu’il croyait réel était une mise en scène." },
  { categorie: "Voix inattendue", abstraction: "forme", consigne: "Laisse un moustique raconter sa propre histoire de survie dans un monde d’humains." },
  { categorie: "Langue étrangère", abstraction: "contrainte", consigne: "Insère une expression étrangère mal traduite au cœur du dialogue, avec des conséquences graves." },
  { categorie: "Mythe reconstitué", abstraction: "structure", consigne: "Réécris le mythe d’Orphée et Eurydice dans un monde post-apocalyptique." },
  { categorie: "Défi de pensée", abstraction: "contrainte", consigne: "Écris un texte où chaque action contredit la précédente." },
  { categorie: "Fusion", abstraction: "forme", consigne: "Écris une histoire où deux consciences cohabitent dans le même corps." },
  { categorie: "Micro-geste", abstraction: "déclencheur", consigne: "Construis une tension dramatique entière à partir d’un personnage qui se gratte le bras." },
  { categorie: "Lapsus", abstraction: "événement", consigne: "Un lapsus en apparence insignifiant déclenche une série de révélations en cascade." },
  { categorie: "Suspicion", abstraction: "ressenti", consigne: "Ton personnage est persuadé que tout le monde le surveille, mais est-ce justifié ?" },
  { categorie: "Cadavre narratif", abstraction: "forme", consigne: "Crée un texte troué : des phrases incomplètes, des pans manquants, comme retrouvés dans une ruine." },
  { categorie: "Point de vue inversé", abstraction: "forme", consigne: "Raconte une scène de braquage du point de vue du sac à dos." },
  { categorie: "Temporalité inversée", abstraction: "structure", consigne: "Fais commencer ton récit par la conséquence, et terminer par la cause." },
  { categorie: "Miroir", abstraction: "forme", consigne: "Un personnage rencontre son reflet… mais celui-ci a des souvenirs différents." },
  { categorie: "Épiphanie", abstraction: "événement", consigne: "Une révélation soudaine transforme totalement la perception d’un lieu banal." },
  { categorie: "Défi stylistique", abstraction: "contrainte", consigne: "Écris une scène comique dans un style biblique." },
  { categorie: "Contrainte linguistique", abstraction: "contrainte", consigne: "Rédige une scène entière sans utiliser de verbe d’action." }
,
  {"categorie": "Silence", "abstraction": "contrainte de dialogue", "consigne": "Rédige une scène où aucun mot n’est prononcé. Tout passe par les gestes, les regards, les silences."},
  {"categorie": "Rupture du réel", "abstraction": "défi conceptuel", "consigne": "Raconte une journée banale qui se dérègle de façon absurde, jusqu’à ne plus suivre aucune logique."},
  {"categorie": "Rupture du réel", "abstraction": "défi conceptuel", "consigne": "Tout semble normal jusqu’à ce qu’un détail minuscule dérègle l’univers du récit. N’explique rien."},
  {"categorie": "Présent toxique", "abstraction": "contexte social", "consigne": "Écris un récit dont tous les éléments se déroulent dans un présent oppressant, sans retour possible vers le passé."},
  {"categorie": "Présent toxique", "abstraction": "contexte social", "consigne": "Dans un futur proche où tout paraît parfait, une personne réalise que le présent est en réalité invivable."},
  {"categorie": "Point de vue inversé", "abstraction": "jeu narratif", "consigne": "Un animal de compagnie raconte la vie d’un couple à travers ses yeux."},
  {"categorie": "Point de vue inversé", "abstraction": "jeu narratif", "consigne": "Raconte une rupture du point de vue… du canapé sur lequel elle se déroule."},
  {"categorie": "Observation", "abstraction": "ancrage", "consigne": "Un personnage devient obsédé par les habitudes d’un inconnu qu’il observe chaque jour à heure fixe."},
  {"categorie": "Observation", "abstraction": "ancrage", "consigne": "Écris une scène uniquement en décrivant ce qu’un personnage voit à travers sa fenêtre, sans jamais intervenir."},
  {"categorie": "Objet narratif", "abstraction": "point de vue", "consigne": "Un objet passe de main en main à travers les âges. Chaque chapitre raconte son destin par son nouveau propriétaire."},
  {"categorie": "Objet narratif", "abstraction": "point de vue", "consigne": "L’histoire est racontée par un objet témoin (ex. un briquet, un sac à main, une caméra de surveillance)."},
  {"categorie": "Objet décalé", "abstraction": "transposition poétique", "consigne": "Une société entière est construite autour d’un objet insignifiant (ex. une vis rouillée, une pile usée)."},
  {"categorie": "Objet décalé", "abstraction": "transposition poétique", "consigne": "Un objet banal devient un totem ou une relique. Raconte comment on lui a attribué un pouvoir sacré."},
  {"categorie": "Mythe reconstitué", "abstraction": "réécriture", "consigne": "Imagine un personnage moderne qui finit par incarner un dieu antique sans le vouloir."},
  {"categorie": "Mythe reconstitué", "abstraction": "réécriture", "consigne": "Réinvente un mythe ancien (ex : Prométhée, Sisyphe) dans un cadre contemporain, en modifiant les rôles."},
  {"categorie": "Miroir", "abstraction": "structure symbolique", "consigne": "Un personnage se confronte à son reflet dans un miroir, qui lui parle et l’influence."},
  {"categorie": "Miroir", "abstraction": "structure symbolique", "consigne": "L’histoire est parfaitement symétrique : le dernier paragraphe reflète mot pour mot le premier. Donne-lui un sens caché."},
  {"categorie": "Micro-geste", "abstraction": "focalisation", "consigne": "Un petit geste, anodin, entraîne une réaction en chaîne imprévisible. Décris avec minutie ce point de bascule."},
  {"categorie": "Micro-geste", "abstraction": "focalisation", "consigne": "Écris une scène entière (2 pages minimum) autour d’un seul geste : s’allumer une cigarette, remettre une mèche derrière l’oreille, etc."},
  {"categorie": "Lapsus", "abstraction": "défi de langage", "consigne": "Fais évoluer ton récit autour d’un lapsus qui devient viral, mal interprété ou détourné par les autres."},
  {"categorie": "Lapsus", "abstraction": "défi de langage", "consigne": "Un personnage dit quelque chose par erreur. Cette phrase révèle involontairement un secret ou une vérité qu’il ignore lui-même."},
  {"categorie": "Fusion", "abstraction": "défi conceptuel", "consigne": "Mélange deux personnages d’univers différents (ex. Sherlock Holmes + Alien). Fais-les coexister dans un même corps, avec des conflits internes."},
  {"categorie": "Fusion", "abstraction": "défi conceptuel", "consigne": "Deux personnes fusionnent littéralement dans un moment d’émotion extrême. Décris leur perception du monde à travers cette nouvelle entité."},
  {"categorie": "Cadavre narratif", "abstraction": "défi structurel", "consigne": "Commence par la fin d’une histoire dont personne ne connaît le début, puis dresse un puzzle incomplet à rebours."},
  {"categorie": "Cadavre narratif", "abstraction": "défi structurel", "consigne": "Écris un texte en fragments incohérents, comme s’il était retrouvé incomplet, ou brûlé, ou mal scanné. Laisse le lecteur recoller les morceaux."}];